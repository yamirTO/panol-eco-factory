...
function renderTablaOT() {
    ...
    tbody.innerHTML = filtrados.map((o, idx) => {
        ...
        const tipoColor = o.tipo === 'Preventivo' ? 'badge-info' : (o.tipo === 'Correctivo' || o.tipo === 'Correctivo Programado' ? 'badge-warning' : 'badge');
...
function processFileOT(file) {
    ...
    reader.onload = function(e) {
        try {
            ...
            // Leer hojas Maquinas, Tecnicos, Modulo intervenido
